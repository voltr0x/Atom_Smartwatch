package com.voltrox.atom.connectivity;
...
public class ConnectActivity extends AppCompatActivity {
        ...
        private final String DEVICE_ADDRESS = "B8:27:EB:D1:BA:9D"; //MAC Address of Bluetooth Module
        ...
        public void weatherData(){
            if (BTinit()) {
                ...
                String[] weatherStringArray = OpenWeatherJsonUtils.sendWeatherData;
                sendCommand();
            }
        }
